...
| <a name="input_cert_diff_variables"></a> [cert\_diff\_variables](#input\_cert\_diff\_variables) | (Optional) Cert diff pipeline variables | <pre>object({<br/>    enabled           = bool<br/>    alert_enabled     = bool<br/>    cert_diff_version = string<br/>    app_insights_name = string<br/>    app_insights_rg   = string<br/>    actions_group     = list(string)<br/>  })</pre> | <pre>{<br/>  "actions_group": [],<br/>  "alert_enabled": false,<br/>  "app_insights_name": "",<br/>  "app_insights_rg": "",<br/>  "cert_diff_version": "0.2.5",<br/>  "enabled": false<br/>}</pre> | no |
